# RailsAdmin config file. Generated on January 06, 2013 03:32
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Ibharti Radio', 'Admin']
  ...
  # config.excluded_models = ['Category', 'City', 'College', 'Language', 'Role', 'Song', 'SongUpload', 'Tag', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Category', 'City', 'College', 'Language', 'Role', 'Song', 'SongUpload', 'Tag', 'User']
  ...
  #     configure :roles, :has_many_association 
  #     configure :colleges, :has_many_association 
  ...
  #     configure :roles, :has_many_association 
  #     configure :song_upload, :has_one_association 
  ...
  # config.model 'SongUpload' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your song_upload.rb model definition
